...
that there should be a nugget effect. Although, given the sudden variation apparent over
short distances, I will go ahead and run a test with the nugget as a fitting parameter.
