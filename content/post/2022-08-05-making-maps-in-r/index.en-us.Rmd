...
ggplot() +
  ...
  geom_sf(data=Contours_IDW, color="red") +
  geom_sf(data=Contours_sm2, color="blue", alpha=0.0) +
  annotate("text", label="C.I. = 0.5 inches of rain", x=bbox_xy[['xmin']]+5000, 
                                              y=bbox_xy[['ymin']]-1000) +
  labs(title="Final X-Y plot of Kriged data",
