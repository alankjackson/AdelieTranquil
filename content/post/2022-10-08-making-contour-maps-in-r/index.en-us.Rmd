...
Note that the smoothing step I have shown is actually inappropriate for this
...
to make sure they make sense and that things are working properly.
...
though that it still requires sp objects, and doesn't (yet?) support sf.
