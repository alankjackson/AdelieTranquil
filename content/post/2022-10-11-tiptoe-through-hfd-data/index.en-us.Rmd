...
df_all_poly %>% 
  ...
  ggplot() +
    Base_basemapR +
    geom_sf(aes(fill=n), alpha=0.3)+
    scale_fill_gradientn(colors=rainbow(5), limits=c(0.0, 100))+
